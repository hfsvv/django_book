...
from .forms import BookCreateForm,LoginForm
...
class Books(TemplateView):
    ...
    context={}
    # books=Book.objects.all()
    # context["object_list"]=books    by default
    # context_object_name = "books"  to change name

    template_name = "book/bookcreate.html"
    def get(self,request,*args,**kwargs):
        books=self.model.objects.all()
        self.context["object_list"]=books
